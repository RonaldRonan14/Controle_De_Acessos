...
public partial class Index : Form
{
    ...
    {
        new AccessDataForm.Create(_userId, _serviceProvider).ShowDialog();
        GetAllAccessData();
    }
    ...
    private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
    {
        ...
        new AccessDataForm.Details(_serviceProvider, accessDataId).ShowDialog();
        GetAllAccessData();
    }
    ...
    {
        new UsersForm.Details(_serviceProvider, _userId).ShowDialog();
    }
